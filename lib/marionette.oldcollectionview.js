...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('backbone.marionette'), require('underscore'), require('backbone')) :
	typeof define === 'function' && define.amd ? define(['exports', 'backbone.marionette', 'underscore', 'backbone'], factory) :
	(factory((global.oldcollectionview = {}),global.Backbone.Marionette,global._,global.Backbone));
}(this, (function (exports,Marionette,_,Backbone) { 'use strict';
...
// For tests
Marionette__default.triggerMethodOn = triggerMethodOn;
...
var ViewMixin = _.pick(Marionette.View.prototype, 'Dom', 'supportsRenderLifecycle', 'supportsDestroyLifecycle', '_isDestroyed', 'isDestroyed', '_isRendered', 'isRendered', '_isAttached', 'isAttached', 'delegateEvents', '_getEvents', '_getTriggers', 'delegateEntityEvents', 'undelegateEntityEvents', 'destroy', '_removeElement', 'bindUIElements', 'unbindUIElements', 'getUI', 'triggerMethod', '_buildEventProxies', '_getEventPrefix', '_proxyChildViewEvents', '_childViewEventHandler',
// BehaviorsMixin
'_initBehaviors', '_getBehaviors', '_getBehaviorTriggers', '_getBehaviorEvents', '_proxyBehaviorViewProperties', '_delegateBehaviorEntityEvents', '_undelegateBehaviorEntityEvents', '_deleteEntityEventHandlers', '_destroyBehaviors', '_removeBehavior', '_bindBehaviorUIElements', '_unbindBehaviorUIElements', '_triggerEventOnBehaviors',
// CommonMixin
...
var MixinFromView = _.pick(Marionette.View.prototype, 'serializeModel', 'getTemplate', '_renderTemplate', '_renderHtml', 'mixinTemplateContext', 'attachElContent');
_.extend(CompositeView.prototype, MixinFromView);

// Support the default export
Marionette__default.OldCollectionView = CollectionView;
Marionette__default.OldCompositeView = CompositeView;

exports.OldCollectionView = CollectionView;
exports.OldCompositeView = CompositeView;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=marionette.oldcollectionview.js.map
