...
import Marionette, { View, getOption } from 'backbone.marionette';
...
function triggerMethod(event) {
  ...
  var method = getOption(this, methodName);
  var result = void 0;
...
var setDomApi = View.setDomApi;

var ViewMixin = _.pick(View.prototype, 'Dom', 'supportsRenderLifecycle', 'supportsDestroyLifecycle', '_isDestroyed', 'isDestroyed', '_isRendered', 'isRendered', '_isAttached', 'isAttached', 'delegateEvents', '_getEvents', '_getTriggers', 'delegateEntityEvents', 'undelegateEntityEvents', 'destroy', '_removeElement', 'bindUIElements', 'unbindUIElements', 'getUI', 'triggerMethod', '_buildEventProxies', '_getEventPrefix', '_proxyChildViewEvents', '_childViewEventHandler',
// BehaviorsMixin
